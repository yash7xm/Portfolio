...
function About() {
  return (
    <div className="about">
      <div className="abt-btn">About Me</div>
      <div className="abt-content">
        <div className="as0">
          ...
          <div className="my-info">
            ...
            <div className="bdy mrb cr-0">
              A Computer Engineering student passionate about programming
              language development, web tech, and software engineering. I'm
              focused on creating innovative projects and tackling coding
              challenges. Beyond academia, I've crafted a custom language, built
              an Integrated Learning Platform (ILP), and led the development of
              an interactive typing web app.
            </div>
            <div className="bdy cr-1">
              ...
              academics and projects mirrors my passion for pushing the
              boundaries of what's possible in the tech realm. Let's connect and
              explore the limitless possibilities of coding together!
            </div>
          </div>
        </div>
        <div className="as1">
          ...
          <div className="contact block">
            ...
            <a href="https://github.com/yash7xm" className="hd clr">
              ↳ github.com/yash7xm
            </a>
            <div></div>
            <a href="https://twitter.com/Yash_Poonia_" className="hd clr">
              ↳ twitter.com/Yash_Poonia_
            </a>
            <div></div>
            <a href="https://www.linkedin.com/in/YashPoonia" className="hd clr">
              ↳ linkedin.com/in/YashPoonia
            </a>
            <div></div>
            <a href="https://leetcode.com/Yash_7xm/" className="hd clr">
          ...
          <div className="achievements block">
            ...
            <div className="bdy">↳ Created a custom programming language.</div>
            <div className="bdy">
